...
import { IClient, IRequest, IResponse, RequestOptions } from "@konceiver/httpie";
import got from "got";
...
export class Client implements IClient {
	public async get(url: string, options?: RequestOptions): Promise<IResponse> {
		return this.sendRequest(new Request().withMethod("get").withUrl(url).withOptions(options));
	}

	public async post(url: string, options?: RequestOptions): Promise<IResponse> {
		return this.sendRequest(new Request().withMethod("post").withUrl(url).withOptions(options));
	}

	public async put(url: string, options?: RequestOptions): Promise<IResponse> {
		return this.sendRequest(new Request().withMethod("put").withUrl(url).withOptions(options));
	}

	public async patch(url: string, options?: RequestOptions): Promise<IResponse> {
		return this.sendRequest(new Request().withMethod("patch").withUrl(url).withOptions(options));
	}

	public async head(url: string, options?: RequestOptions): Promise<IResponse> {
		return this.sendRequest(new Request().withMethod("head").withUrl(url).withOptions(options));
	}

	public async delete(url: string, options?: RequestOptions): Promise<IResponse> {
		return this.sendRequest(new Request().withMethod("delete").withUrl(url).withOptions(options));
	}
